...
def _render_importance_table(importance_df: pd.DataFrame) -> None:
    ...
    for rank, (_, row) in enumerate(
        ...
        arrow = {
            'up':   '<span style="color:#f85149;font-size:0.9rem;">↑</span>',
            'down': '<span style="color:#58a6ff;font-size:0.9rem;">↓</span>',
            'flag': '<span style="color:#e3b341;font-size:0.9rem;">⚑</span>',
        }.get(direction, '')
        ...
        <tr>
            ...
            <td style="color:#e6edf3;font-weight:500;font-family:monospace;font-size:0.78rem;
                word-break:keep-all;white-space:nowrap;">{feat}</td>
            <td style="color:#c9d1d9;text-align:center;">{imp:.4f}</td>
            <td style="text-align:left;white-space:nowrap;">
                {arrow} <span style="font-size:0.7rem;color:#8b949e;">{dir_label}</span>
            </td>
            <td style="color:#8b949e;font-size:0.78rem;white-space:nowrap;">
                {ctx_icon} {ctx_label}
            </td>
        </tr>"""
